...
//_allantilink.js
const smsTextoYT = () => { return '😻 Super CapiBot - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
//_antiviewonce.js
const smsAntiView = () => { return `*OYEE, SE TE OLVIDO QUE TENGO WHATSAPP PLUS* 😎`} 
...
const smsBottem3 = () => { return `SE SALIO UN GAY A CHINGAR A SU MADRE 💖`} 
...
const smsGrupoTime7 = () => { return '🔒 *EL GRUPO ESTA CERRADO, SOLO GAYS PUEDEN ENVIAR MENSAJES*'}
